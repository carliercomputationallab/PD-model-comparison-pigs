...
ax[0,0].plot(range(241),predicted_cd_O['Urea'], label = 'Oberg',ls = '-.', lw = 3) 
...
ax[0,2].scatter(df_cd.index,df_cd.iloc[:,2], label = 'Data', c = 'k') 
ax[0,2].plot(range(241),predicted_cd_G['Sodium'], label = 'fitted', lw = 3) 
ax[0,2].plot(range(241),predicted_cd_W['Sodium'], label = 'fitted', ls = '--', lw = 3)
ax[0,2].plot(range(241),predicted_cd_O['Sodium'], label = 'fitted',ls = '-.', lw = 3)  

ax[0,2].set_title('Sodium')
ax[1,0].scatter(df_cd.index,df_cd.iloc[:,3], label = 'Data', c = 'k') 
ax[1,0].plot(range(241),predicted_cd_G['Phosphate'], label = 'fitted', lw = 3)  
ax[1,0].plot(range(241),predicted_cd_W['Phosphate'], label = 'fitted', ls = '--', lw = 3)
ax[1,0].plot(range(241),predicted_cd_O['Phosphate'], label = 'fitted',ls = '-.', lw = 3) 

ax[1,0].set_title('Phosphate')
ax[1,1].scatter(df_cd.index,df_cd.iloc[:,4], label = 'Data', c = 'k') 
ax[1,1].plot(range(241),predicted_cd_G['Glucose'], label = 'fitted', lw = 3)
ax[1,1].plot(range(241),predicted_cd_W['Glucose'], label = 'fitted', ls = '--', lw = 3)
ax[1,1].plot(range(241),predicted_cd_O['Glucose'], label = 'fitted',ls = '-.', lw = 3)

ax[1,1].set_title('Glucose')
ax[1,2].scatter(df_cd.index,df_cd.iloc[:,5], label = 'Data', c = 'k') 
ax[1,2].plot(range(241),predicted_cd_G['Potassium'], label = 'Garred', lw = 3)
ax[1,2].plot(range(241),predicted_cd_W['Potassium'], label = 'Waniewski', ls = '--', lw = 3)
ax[1,2].plot(range(241),predicted_cd_O['Potassium'], label = 'Oberg',ls = '-.', lw = 3)
...
ax[0,0].plot(range(241),predicted_cd_O2['Urea'], label = 'Oberg-N') 
ax[0,1].plot(range(241),predicted_cd_O2['Creatinine'], label = 'fitted')
ax[0,2].plot(range(241),predicted_cd_O2['Sodium'], label = 'fitted') 
ax[1,0].plot(range(241),predicted_cd_O2['Phosphate'], label = 'fitted') 
ax[1,1].plot(range(241),predicted_cd_O2['Glucose'], label = 'fitted')
ax[1,2].plot(range(241),predicted_cd_O2['Potassium'], label = 'Oberg-N')


predicted_cd_O3 = objective(MTAC_O, predicted_cd_O, Cp, L, V, df_cd, Vr, V_fill, 10.0084, 1.7744)
ax[0,0].plot(range(241),predicted_cd_O3['Urea'], label = 'Oberg-MTAC') 
ax[0,1].plot(range(241),predicted_cd_O3['Creatinine'], label = 'fitted')
ax[0,2].plot(range(241),predicted_cd_O3['Sodium'], label = 'fitted') 
ax[1,0].plot(range(241),predicted_cd_O3['Phosphate'], label = 'fitted') 
ax[1,1].plot(range(241),predicted_cd_O3['Glucose'], label = 'fitted')
ax[1,2].plot(range(241),predicted_cd_O3['Potassium'], label = 'Oberg-MTAC')

ax[0,2].set_ylim(ymax = 131)
