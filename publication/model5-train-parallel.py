# -*- coding: utf-8 -*-
"""
Created on Tue Oct 25 11:31:57 2022
...
def compute(cd, t, x, predicted_cd, Cp, V, df_cd):
    ...
    f = np.array([0 if b > 30 else 0.5 if b == 0 else (1/b)-1/(np.exp(b)-1) for b in beta]) #see model 2 for explanation
    MC = cp-f*(cp-cd)
...
if __name__ == '__main__':
    ...
    df_OV.to_csv('./spiderdata/7_4ratio/model5_iteration3.csv')
