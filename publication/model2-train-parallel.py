# -*- coding: utf-8 -*-
"""
Created on Tue Oct 25 10:19:46 2022
...
# patientlist= ['P10.csv']# ['P9.csv', 'P15.csv', 'P11.csv', 'P21.csv', 'P10.csv', 'P23.csv', 'P8.csv']
...
if __name__ == '__main__':
    ...
    cols = ['MTAC_urea', 'MTAC_crea','MTAC_sodium', 'MTAC_phosphate','MTAC_glu', 'MTAC_potassium',
            'fct_urea', 'fct_crea','fct_sodium', 'fct_phosphate','fct_glu', 'fct_potassium', 'L'] 
    ...
    df_OV.to_csv('./spiderdata/7_4ratio/model2_iteration3.csv')
